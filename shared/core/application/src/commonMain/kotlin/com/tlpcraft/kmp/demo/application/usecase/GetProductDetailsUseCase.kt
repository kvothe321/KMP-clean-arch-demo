...
class GetProductDetailsUseCase(private val productRepository: ProductRepository) : UseCase<Int, Result<ProductPreview>> {
    override suspend fun invoke(param: Int): Result<ProductPreview> = productRepository.getProduct(param)
}
