...
import com.tlpcraft.kmp.demo.feature.productdetails.presentation.di.productDetailsModule
...
fun initKoin(appDeclaration: KoinAppDeclaration = {}) = startKoin {
    appDeclaration()
    modules(coreModule, dataPlatformModule, dataModule, productsModule, productDetailsModule)
}
